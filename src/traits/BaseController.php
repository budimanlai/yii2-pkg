...
trait BaseController {
    ...
    /**
     * Throw a `BadRequestHttpException` with the given message.
    ...
    /**
     * Throw a `BadRequestHttpException` with the first validation error from a Yii2 model.
     * Use this after a failed `$model->validate()` to return the error to the client.
     *
     * @param \yii\base\Model $model The model whose validation errors will be returned
     * @throws BadRequestHttpException Always
     */
     ...
     * Calls `asError()` immediately on the first missing field.
     *
     * @param array|object $json  The input data to validate (e.g. request body)
